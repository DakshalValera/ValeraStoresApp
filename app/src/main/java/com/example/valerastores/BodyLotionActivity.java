...
public class BodyLotionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<MainModel> options = new FirebaseRecyclerOptions.Builder<MainModel>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("lotion"), MainModel.class)
                .build();
        ...
        adapter.setOnItemClickListener(model -> {
            Intent intent = new Intent(BodyLotionActivity.this, DetailActivity.class);
